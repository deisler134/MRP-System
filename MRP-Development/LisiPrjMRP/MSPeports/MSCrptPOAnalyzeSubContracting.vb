...
Public Class MSCrptPOAnalyzeSubContracting
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MSCrptPOAnalyzeSubContracting.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.MSCrptPOAnalyzeSubContracting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMSCrptPOAnalyzeSubContracting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MSCrptPOAnalyzeSubContracting = New MSCrptPOAnalyzeSubContracting()
        rpt.Site = Me.Site
        Return rpt
    End Function
