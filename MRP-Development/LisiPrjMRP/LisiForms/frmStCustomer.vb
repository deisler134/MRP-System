...
Public Class frmStCustomer
    ...
    Private Sub frmStCustomer_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmStCustomers_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        dgContact.DataMember = "tblStCustomers.CustContact"
    ...
    Sub InitialComponents()
        ...
        daCustomers.FillSchema(dsMain, SchemaType.Source, "tblStCustomers")
        daContacts.FillSchema(dsMain, SchemaType.Source, "tblStCustContact")

        daCustomers.Fill(dsMain, "tblStCustomers")
        Dim CustID As DataColumn = dsMain.Tables("tblStCustomers").Columns("CustomerID")
        ...
        daContacts.Fill(dsMain, "tblStCustContact")
        Dim ContID As DataColumn = dsMain.Tables("tblStCustContact").Columns("ContactID")
        ...
        With dsMain
            .Relations.Add("CustContact", _
                .Tables("tblStCustomers").Columns("CustomerID"), _
                .Tables("tblStCustContact").Columns("CustomerID"), True)
        End With

        cmCust = CType(BindingContext(dsMain, "tblStCustomers"), CurrencyManager)
        cmCont = CType(BindingContext(dsMain, "tblStCustContact"), CurrencyManager)

    End Sub

    Sub SetCtlForm()

        CmbCust.DataSource = dsMain.Tables("tblStCustomers")
    ...
    Private Sub CmdCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdCancel.Click
        ...
        Me.BindingContext(dsMain, "tblStCustomers").Position = CType(CmbCust.SelectedIndex, String)
        dsMain.RejectChanges()
        dgContact.Refresh()
    ...
    Private Sub CmdNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdNew.Click
        ...
        Me.BindingContext(dsMain, "tblStCustomers").EndCurrentEdit()
        Me.BindingContext(dsMain, "tblStCustomers").AddNew()
    ...
    Private Function BindFields() As Boolean
        ...
        txtCustID.DataBindings.Add("Text", dsMain, "tblStCustomers.CustomerID")
        txtCustName.DataBindings.Add("Text", dsMain, "tblStCustomers.CustomerName")
        txtShipVia.DataBindings.Add("Text", dsMain, "tblStCustomers.CustShipVia")
        txtPer.DataBindings.Add("Text", dsMain, "tblStCustomers.SalesRepPer")
        txtCustShort.DataBindings.Add("Text", dsMain, "tblStCustomers.CustomerShort")
        txtAddress.DataBindings.Add("Text", dsMain, "tblStCustomers.Address")
        txtCity.DataBindings.Add("Text", dsMain, "tblStCustomers.City")
        txtRegion.DataBindings.Add("Text", dsMain, "tblStCustomers.Region")
        txtPostalCode.DataBindings.Add("Text", dsMain, "tblStCustomers.PostalCode")
        cmbCountry.DataBindings.Add("Text", dsMain, "tblStCustomers.Country")
        txtWeb.DataBindings.Add("Text", dsMain, "tblStCustomers.WebAddress")
        txtNotes.DataBindings.Add("Text", dsMain, "tblStCustomers.Notes")
        CmbCreditInfo.DataBindings.Add("Text", dsMain, "tblStCustomers.CreditInfo")
    ...
    Private Function BuildSqlCommand() As Boolean
        ...
        Try
            daCustomers = CallClass.PopulateDataAdapter("gettblStCustomers")
            daContacts = CallClass.PopulateDataAdapter("gettblStCustContact")
            ...
            daCustomers.TableMappings.Add("Table", "tblStCustomers")
            ...
            daContacts.TableMappings.Add("Table", "tblStCustContact")
    ...
    Private Sub HandleRowUpdatedContact(ByVal sender As Object, ByVal e As SqlRowUpdatedEventArgs)
        ...
        If e.Status = UpdateStatus.Continue AndAlso e.StatementType = StatementType.Insert Then
            e.Row(dsMain.Tables("tblStCustContact").Columns("ContactID")) = Int32.Parse(cmdGetIdentity.ExecuteScalar.ToString)
            e.Row.AcceptChanges()
        End If
    ...
    Private Sub HandleRowUpdatedCustomer(ByVal sender As Object, ByVal e As SqlRowUpdatedEventArgs)
        ...
        Dim cmdGetIdentity As New SqlCommand("SELECT @@IDENTITY", cn)
        If e.Status = UpdateStatus.Continue AndAlso e.StatementType = StatementType.Insert Then
            e.Row(dsMain.Tables("tblStCustomers").Columns("CustomerID")) = Int32.Parse(cmdGetIdentity.ExecuteScalar.ToString)
            e.Row.AcceptChanges()
        End If
    ...
    Private Sub CmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdSave.Click
        ...
        Try
            If dsMain.HasChanges Then
                daCustomers.Update(dsMain.Tables("tblStCustomers").Select("", "", DataViewRowState.Added Or DataViewRowState.ModifiedCurrent))
                daContacts.Update(dsMain.Tables("tblStCustContact").Select("", "", DataViewRowState.Deleted Or DataViewRowState.Added Or DataViewRowState.ModifiedCurrent))
                daCustomers.Update(dsMain.Tables("tblStCustomers").Select("", "", DataViewRowState.Deleted))
