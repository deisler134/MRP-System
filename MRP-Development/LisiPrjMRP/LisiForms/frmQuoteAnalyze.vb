...
Public Class frmQuoteAnalyze
    ...
    Private Sub frmQuoteAnalyze_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        dsMain.Clear()
    ...
    Private Sub frmQuoteAnalyze_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call SetupForm()
    End Sub
    ...
    Sub SetCtlForm()
        ...
        With Me.SwCustPO
            .DataPropertyName = "SwCustPO"
            .Name = "SwCustPO"
        End With

        With Me.SwCustDatePO
            .DataPropertyName = "SwCustDatePO"
            .Name = "SwCustDatePO"
        End With
