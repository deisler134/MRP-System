...
Public Class frmPartProcAccessByPart
    ...
    Private Sub frmPartProcAccessByPart_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmPartProcAccessByPart_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        FindItem = SwIndex.Text

        daaPart = CallClass.PopulateDataAdapterSearchStrAndStr("gettblPartProcAccessByPart", SwPart, FindItem)
