...
Public Class frmQuoteRemarks
    ...
    Private Sub frmQuoteRemarks_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmQuoteRemarks_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        GC.Collect()

        If SwFrom.Text = "Header" Then
            tempText = frmQuote.txtHeader.Text
        Else
            tempText = frmQuote.txtFooter.Text
        End If

        Connect()

        da.FillSchema(ds, SchemaType.Source, "tblQuoteRemark")
        da.Fill(ds, "tblQuoteRemark")

        Dim RemID As DataColumn = ds.Tables("tblQuoteRemark").Columns("QTRemarkID")
        ...
        currRemark = CType(BindingContext(ds, "tblQuoteRemark"), CurrencyManager)
        ...
        dv.Table = ds.Tables("tblQuoteRemark")
    ...
    Private Function Connect() As Boolean
        ...
        strSQL = "Select * FROM tblQuoteRemark Order by QTRemarkText"
        ...
        Try
            ...
            da.TableMappings.Add("Table", "tblQuoteRemark")
    ...
    Private Sub HandleRowUpdatedRemark(ByVal sender As Object, ByVal e As SqlRowUpdatedEventArgs)
        ...
        If e.Status = UpdateStatus.Continue AndAlso e.StatementType = StatementType.Insert Then
            e.Row(ds.Tables("tblQuoteRemark").Columns("QTRemarkID")) = Int32.Parse(cmdGetIdentity.ExecuteScalar.ToString)
            e.Row.AcceptChanges()
        End If
    ...
    Private Sub CmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdSave.Click
        ...
        Me.BindingContext(ds, "tblQuoteRemark").EndCurrentEdit()

        Try
            If ds.HasChanges Then
                da.Update(ds.Tables("tblQuoteRemark").Select("", "", DataViewRowState.Added Or DataViewRowState.ModifiedCurrent Or DataViewRowState.Deleted))
            End If
    ...
    Private Sub dg_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dg.DoubleClick
        ...
        If SwFrom.Text = "Header" Then
            If IsDBNull(tempText) = True Or Len(Trim(tempText)) = 0 Then
                frmQuote.txtHeader.Text = Me.dg("QTRemarkText", Rawgrid).Value
                tempText = Me.dg("QTRemarkText", Rawgrid).Value
            Else
                frmQuote.txtHeader.Text = frmQuote.txtHeader.Text + vbCrLf
                frmQuote.txtHeader.Text = frmQuote.txtHeader.Text + Me.dg("QTRemarkText", Rawgrid).Value
            End If
        Else
            If IsDBNull(tempText) = True Or Len(Trim(tempText)) = 0 Then
                frmQuote.txtFooter.Text = Me.dg("QTRemarkText", Rawgrid).Value
                tempText = Me.dg("QTRemarkText", Rawgrid).Value
            Else
                frmQuote.txtFooter.Text = frmQuote.txtFooter.Text + vbCrLf
                frmQuote.txtFooter.Text = frmQuote.txtFooter.Text + Me.dg("QTRemarkText", Rawgrid).Value
            End If
        End If
