...
Public Class rptRawMatlByOderPart
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRawMatlByOderPart.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptRawMatlByOderPart.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_subRptRawMatlSeeTranz_YearTo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptRawMatlByOderPart
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRawMatlByOderPart = New rptRawMatlByOderPart()
        rpt.Site = Me.Site
        Return rpt
    End Function
