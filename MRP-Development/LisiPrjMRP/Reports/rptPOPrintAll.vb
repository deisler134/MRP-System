...
Public Class rptPOPrintAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptPOPrintAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PO_Status() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPOPrintAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPOPrintAll = New rptPOPrintAll()
        rpt.Site = Me.Site
        Return rpt
    End Function
