...
Public Class KillrptRMSeeTranz
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.KillrptRMSeeTranz.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedKillrptRMSeeTranz
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As KillrptRMSeeTranz = New KillrptRMSeeTranz()
        rpt.Site = Me.Site
        Return rpt
    End Function
