...
Public Class rptQAIndSuppliers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptQAIndSuppliers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptQAIndSuppliers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptQAIndSuppliers = New rptQAIndSuppliers()
        rpt.Site = Me.Site
        Return rpt
    End Function
