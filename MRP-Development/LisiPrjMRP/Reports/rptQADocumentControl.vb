...
Public Class rptQADocumentControl
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptQADocumentControl.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptQADocumentControl.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptQADocumentControl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptQADocumentControl = New rptQADocumentControl()
        rpt.Site = Me.Site
        Return rpt
    End Function
