...
Public Class rptRawMatlAdjTranz
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptRawMatlAdjTranz.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRawMatlAdjTranz
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRawMatlAdjTranz = New rptRawMatlAdjTranz()
        rpt.Site = Me.Site
        Return rpt
    End Function
