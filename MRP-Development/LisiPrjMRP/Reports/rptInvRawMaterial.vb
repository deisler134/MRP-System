...
Public Class rptInvRawMaterial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptInvRawMaterial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvRawMaterial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvRawMaterial = New rptInvRawMaterial()
        rpt.Site = Me.Site
        Return rpt
    End Function
