...
Public Class rptMatlLotNumber
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptMatlLotNumber.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMatlLotNumber
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMatlLotNumber = New rptMatlLotNumber()
        rpt.Site = Me.Site
        Return rpt
    End Function
