...
Public Class rptPrintPOByType
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptPrintPOByType.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Po_Type() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPrintPOByType
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintPOByType = New rptPrintPOByType()
        rpt.Site = Me.Site
        Return rpt
    End Function
