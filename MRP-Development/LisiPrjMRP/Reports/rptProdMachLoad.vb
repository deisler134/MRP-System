...
Public Class rptProdMachLoad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptProdMachLoad.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NoHrs() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptProdMachLoad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProdMachLoad = New rptProdMachLoad()
        rpt.Site = Me.Site
        Return rpt
    End Function
