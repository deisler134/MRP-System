...
Public Class rptMaintEquipList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptMaintEquipList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMaintEquipList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMaintEquipList = New rptMaintEquipList()
        rpt.Site = Me.Site
        Return rpt
    End Function
