...
Public Class rptPartRefListWithBlanks
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPartRefListWithBlanks.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptPartRefListWithBlanks.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPartRefListWithBlanks
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPartRefListWithBlanks = New rptPartRefListWithBlanks()
        rpt.Site = Me.Site
        Return rpt
    End Function
