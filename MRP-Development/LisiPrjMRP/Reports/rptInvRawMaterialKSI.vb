...
Public Class rptInvRawMaterialKSI
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInvRawMaterialKSI.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptInvRawMaterialKSI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvRawMaterialKSI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvRawMaterialKSI = New rptInvRawMaterialKSI()
        rpt.Site = Me.Site
        Return rpt
    End Function
