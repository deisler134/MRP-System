...
Public Class subInvRawMatlKSI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.subInvRawMatlKSI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedsubInvRawMatlKSI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As subInvRawMatlKSI = New subInvRawMatlKSI()
        rpt.Site = Me.Site
        Return rpt
    End Function
