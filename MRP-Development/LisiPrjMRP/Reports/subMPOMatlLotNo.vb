...
Public Class subMPOMatlLotNo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.subMPOMatlLotNo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedsubMPOMatlLotNo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As subMPOMatlLotNo = New subMPOMatlLotNo()
        rpt.Site = Me.Site
        Return rpt
    End Function
