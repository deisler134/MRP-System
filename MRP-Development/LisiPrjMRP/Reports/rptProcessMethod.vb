...
Public Class rptProcessMethod
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptProcessMethod.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProcessMethod
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProcessMethod = New rptProcessMethod()
        rpt.Site = Me.Site
        Return rpt
    End Function
