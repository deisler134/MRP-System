...
Public Class rptRawMatlRelTranz
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptRawMatlRelTranz.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRawMatlRelTranz
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRawMatlRelTranz = New rptRawMatlRelTranz()
        rpt.Site = Me.Site
        Return rpt
    End Function
