...
Public Class rptQuoteListByCust
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptQuoteListByCust.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptQuoteListByCust
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptQuoteListByCust = New rptQuoteListByCust()
        rpt.Site = Me.Site
        Return rpt
    End Function
