...
Public Class rptDOsContractReview
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDOsContractReview.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptDOsContractReview.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDOsContractReview
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDOsContractReview = New rptDOsContractReview()
        rpt.Site = Me.Site
        Return rpt
    End Function
