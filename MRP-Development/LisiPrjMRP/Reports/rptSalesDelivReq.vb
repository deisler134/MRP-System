...
Public Class rptSalesDelivReq
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptSalesDelivReq.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_txtReqNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptSalesDelivReq
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesDelivReq = New rptSalesDelivReq()
        rpt.Site = Me.Site
        Return rpt
    End Function
