...
Public Class rptLisiInvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptLisiInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLisiInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLisiInvoice = New rptLisiInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
