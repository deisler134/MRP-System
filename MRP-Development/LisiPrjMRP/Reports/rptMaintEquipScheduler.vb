...
Public Class rptMaintEquipScheduler
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptMaintEquipScheduler.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptMaintEquipScheduler.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NoDays() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptMaintEquipScheduler
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMaintEquipScheduler = New rptMaintEquipScheduler()
        rpt.Site = Me.Site
        Return rpt
    End Function
