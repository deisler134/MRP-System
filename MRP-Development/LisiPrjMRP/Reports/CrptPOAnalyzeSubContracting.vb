...
Public Class CrptPOAnalyzeSubContracting
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrptPOAnalyzeSubContracting.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.CrptPOAnalyzeSubContracting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptPOAnalyzeSubContracting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrptPOAnalyzeSubContracting = New CrptPOAnalyzeSubContracting()
        rpt.Site = Me.Site
        Return rpt
    End Function
