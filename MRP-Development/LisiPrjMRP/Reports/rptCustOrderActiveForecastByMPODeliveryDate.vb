...
Public Class rptCustOrderActiveForecastByMPODeliveryDate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCustOrderActiveForecastByMPODeliveryDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptCustOrderActiveForecastByMPODeliveryDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustOrderActiveForecastByMPODeliveryDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustOrderActiveForecastByMPODeliveryDate = New rptCustOrderActiveForecastByMPODeliveryDate()
        rpt.Site = Me.Site
        Return rpt
    End Function
