...
Public Class rptRawMatlSeeTranz
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptRawMatlSeeTranz.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRawMatlSeeTranz
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRawMatlSeeTranz = New rptRawMatlSeeTranz()
        rpt.Site = Me.Site
        Return rpt
    End Function
