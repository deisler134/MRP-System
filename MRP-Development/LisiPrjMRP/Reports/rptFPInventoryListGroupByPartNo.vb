...
Public Class rptFPInventoryListGroupByPartNo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFPInventoryListGroupByPartNo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptFPInventoryListGroupByPartNo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_subRptFpInvByPartNo_Delivery_Priode() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptFPInventoryListGroupByPartNo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFPInventoryListGroupByPartNo = New rptFPInventoryListGroupByPartNo()
        rpt.Site = Me.Site
        Return rpt
    End Function
