...
Public Class rptLisiPslipCOC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptLisiPslipCOC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLisiPslipCOC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLisiPslipCOC = New rptLisiPslipCOC()
        rpt.Site = Me.Site
        Return rpt
    End Function
