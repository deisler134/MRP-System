...
Public Class rptPartToolBox
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptPartToolBox.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPartToolBox
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPartToolBox = New rptPartToolBox()
        rpt.Site = Me.Site
        Return rpt
    End Function
