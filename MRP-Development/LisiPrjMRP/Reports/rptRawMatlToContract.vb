...
Public Class rptRawMatlToContract
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptRawMatlToContract.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptRawMatlToContract.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRawMatlToContract
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRawMatlToContract = New rptRawMatlToContract()
        rpt.Site = Me.Site
        Return rpt
    End Function
