...
Public Class rptPrintPOBySupp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptPrintPOBySupp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrintPOBySupp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintPOBySupp = New rptPrintPOBySupp()
        rpt.Site = Me.Site
        Return rpt
    End Function
