...
Public Class rptPartFromBlanks
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptPartFromBlanks.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PartSelect() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPartFromBlanks
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPartFromBlanks = New rptPartFromBlanks()
        rpt.Site = Me.Site
        Return rpt
    End Function
