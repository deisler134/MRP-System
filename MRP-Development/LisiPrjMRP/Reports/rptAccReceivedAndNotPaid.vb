...
Public Class rptAccReceivedAndNotPaid
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAccReceivedAndNotPaid.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptAccReceivedAndNotPaid.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAccReceivedAndNotPaid
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAccReceivedAndNotPaid = New rptAccReceivedAndNotPaid()
        rpt.Site = Me.Site
        Return rpt
    End Function
