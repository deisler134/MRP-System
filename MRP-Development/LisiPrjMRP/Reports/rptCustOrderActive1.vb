...
Public Class rptCustOrderActive
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptCustOrderActive.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustOrderActive
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustOrderActive = New rptCustOrderActive()
        rpt.Site = Me.Site
        Return rpt
    End Function
