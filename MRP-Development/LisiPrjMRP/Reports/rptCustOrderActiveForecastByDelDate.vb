...
Public Class rptCustOrderActiveForecastByDelDate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCustOrderActiveForecastByDelDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptCustOrderActiveForecastByDelDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_subForecastByDelivDate_txtPSlipNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCustOrderActiveForecastByDelDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustOrderActiveForecastByDelDate = New rptCustOrderActiveForecastByDelDate()
        rpt.Site = Me.Site
        Return rpt
    End Function
