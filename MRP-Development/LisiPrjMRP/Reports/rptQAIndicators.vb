...
Public Class rptQAIndicators
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptQAIndicators.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptQAIndicators
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptQAIndicators = New rptQAIndicators()
        rpt.Site = Me.Site
        Return rpt
    End Function
