...
Public Class rptQuoteListByPart
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptQuoteListByPart.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptQuoteListByPart
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptQuoteListByPart = New rptQuoteListByPart()
        rpt.Site = Me.Site
        Return rpt
    End Function
