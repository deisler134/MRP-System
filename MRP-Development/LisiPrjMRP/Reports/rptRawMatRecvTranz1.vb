...
Public Class rptRawMatRecvTranz
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptRawMatRecvTranz.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRawMatRecvTranz
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRawMatRecvTranz = New rptRawMatRecvTranz()
        rpt.Site = Me.Site
        Return rpt
    End Function
