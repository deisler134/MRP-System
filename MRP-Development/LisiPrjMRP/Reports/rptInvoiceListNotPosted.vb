...
Public Class rptInvoiceListNotPosted
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInvoiceListNotPosted.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptInvoiceListNotPosted.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Document_Type() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptInvoiceListNotPosted
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvoiceListNotPosted = New rptInvoiceListNotPosted()
        rpt.Site = Me.Site
        Return rpt
    End Function
