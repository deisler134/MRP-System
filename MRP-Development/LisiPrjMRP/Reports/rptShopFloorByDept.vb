...
Public Class rptShopFloorByDept
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptShopFloorByDept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptShopFloorByDept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptShopFloorByDept = New rptShopFloorByDept()
        rpt.Site = Me.Site
        Return rpt
    End Function
