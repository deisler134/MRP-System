...
Public Class rptQuoteSuccessYD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LisiPrjMRP.rptQuoteSuccessYD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptQuoteSuccessYD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptQuoteSuccessYD = New rptQuoteSuccessYD()
        rpt.Site = Me.Site
        Return rpt
    End Function
